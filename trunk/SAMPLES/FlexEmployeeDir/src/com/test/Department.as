 ...
 */
[RemoteClass(alias="com.test.Department")]
public class Department extends Department_EO { 

	/**
	 * Creates a new instance and sets the entity type.
	 */
	public static function createNewInstance():Department {
		var instance:Department = new Department();
		instance.entity = MetaDomain.getInstance().getEntityByName(Department_EO.SYSTEM_NAME);
		return instance;
	}
