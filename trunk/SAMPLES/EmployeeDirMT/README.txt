...
A2. Config the database in WebContent/WEB-INF/eo-config.xml
	 ...
	 <property name="java-source-local-dir" value="C:\EmployeeDirMT\src"/> <!-- absolute path -->
...
A1. Config the database in WebContent/WEB-INF/eo-config.xml
     ...
     <db>C:\EmployeeDirMT\db\derby_employeedirmt</db>		<!-- absolute path -->
	 <property name="java-source-local-dir" value="C:\EmployeeDirMT\src"/> <!-- absolute path -->
...
C1. Click 'Metadata I/E' button on the navigation panel, browse the db/employeedirmt-metadata.xml file and click 'Import' to import entities.
